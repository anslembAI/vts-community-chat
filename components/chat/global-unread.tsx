...
export function GlobalUnreadBadge() {
    ...
    return (
        <div
            className="vts-icon-button relative flex h-9 w-9 cursor-pointer items-center justify-center rounded-full text-black/80 transition-colors hover:bg-white/60 md:h-11 md:w-11"
            title={`${globalUnreadCount} unread messages`}
        >
            <MessageSquare className="h-[18px] w-[18px] md:h-5 md:w-5" />
